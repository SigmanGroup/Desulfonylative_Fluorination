...
def plot_single_threshold(hs: Hotspot,
    ...
    if(coloring == 'scaled'):
        ...
        active_symbol = Line2D([0], [0], marker='o', color='w', label='Active Training', markerfacecolor=active_color, markersize=10, markeredgecolor='black')
        inactive_symbol = Line2D([0], [0], marker='o', color='w', label='Inactive Training', markerfacecolor=inactive_color, markersize=10, markeredgecolor='black')
        active_validation_symbol = Line2D([0], [0], marker='s', color='w', label='Active Test', markerfacecolor=active_color, markersize=10, markeredgecolor='black')
        inactive_validation_symbol = Line2D([0], [0], marker='s', color='w', label='Inactive Test', markerfacecolor=inactive_color, markersize=10, markeredgecolor='black')
        ...
        ax.legend(handles=legend_symbols, fontsize=15, loc='lower right', edgecolor='black')
    
    # Draw the threshold line
    ax.axvline(x=hs.thresholds[0].cut_value, color='black', linestyle='--')
    # Draw y_cut line
    ax.axhline(y=hs.y_cut, color='grey', linestyle='--')
